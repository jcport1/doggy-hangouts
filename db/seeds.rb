...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    p1 = Pet.create(name: "lulu", age: "puppy", breed: "pug", size: "small", user:u1).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_1.jpg'), filename: 'dog_1.jpg')
    p2 = Pet.create(name: "buddy", age: "adolescent", breed: "beagle", size: "medium", user:u2).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_2.jpg'), filename: 'dog_2.jpg')
    p3 = Pet.create(name: "coco", age: "adult", breed: "chow chow", size: "large", user:u3).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_3.jpg'), filename: 'dog_3.jpg')
    p4 = Pet.create(name: "baxter", age: "senior", breed: "pomeranian", size: "small", user:u4).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_4.jpg'), filename: 'dog_4.jpg')
    p5 = Pet.create(name: "baobao", age: "puppy", breed: "shetland sheepdog", size: "medium", user:u5).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_5.jpg'), filename: 'dog_5.jpg')
    p6 = Pet.create(name: "balto", age: "adolescent", breed: "labrador retriever", size: "large", user:u6).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_6.jpg'), filename: 'dog_6.jpg')
    p7 = Pet.create(name: "togo", age: "adult", breed: "chihuahua", size: "small", user:u7).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_7.jpg'), filename: 'dog_7.jpg')
    p8 = Pet.create(name: "champ", age: "senior", breed: "scottish terrier", size: "medium", user:u8).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_8.jpg'), filename: 'dog_8.jpg')
    p9 = Pet.create(name: "bubs", age: "puppy", breed: "corgie", size: "small", user:u1).profile_pic.attach(io: File.open('app/assets/images/seed_images/dogs/dog_9.jpg'), filename: 'dog_9.jpg')
